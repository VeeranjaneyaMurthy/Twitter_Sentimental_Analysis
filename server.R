...
shinyServer(function(input, output) {
   ...
   TweetFrame<-function(twtList)
  {
	...
	pos.words = scan('C:/Users/hp/Documents/Analysig Twitter/positive-words.txt', what='character', comment.char=';')
	neg.words = scan('C:/Users/hp/Documents/Analysig Twitter/negative-words.txt', what='character', comment.char=';')
